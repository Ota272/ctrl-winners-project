...
function spinRoulette() {
    ...
    setTimeout(() => {
        const segmentValues = [
            { color: "Голубой", val: 100 },       
            { color: "Красный", val: 50000 },     
            { color: "Зеленый", val: 10000 },     
            { color: "Желтый", val: 5000 },       
            { color: "Фиолетовый", val: 2000 },   
            { color: "Оранжевый", val: 1000 },    
            { color: "Бирюзовый", val: 500 },     
            { color: "Темный", val: 0 }           
        ];
